      ...
      return (
        <div className="everyComment">
          <div className="everyComment-img">
            ...
            <img src={(item.author.userRole === 'professional') ? require('../assets/images/P.png') : require('../assets/images/C.png')} alt="" style={(item.author.userRole === 'professional') ? {'left': '-5'} : {'right': '-5'}} />
          </div>
