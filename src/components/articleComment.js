      ...
      return (
        <div className="everyComment">
          <div className="everyComment-img">
            ...
            <img src={(item.author.userRole === 'professional') ? require('../assets/images/P.png') : require('../assets/images/C.png')} alt="" className="everyCommentUserRole" style={(item.author.userRole === 'professional') ? {'right': '-5'} : {'left': '-5'}} />
          </div>
